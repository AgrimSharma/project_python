...
module scrumdo {
    ...
    export class BigPictureManager{
        ...
        constructor(private $resource: ng.resource.IResourceService,
            ...
            this.BigPictureApi = <BigPictureResource> this.$resource(API_PREFIX + "organizations/:organizationSlug/projects/:projectSlug/bigpicture/iteration/:iterationId/stats",
                ...
                },
                {
                    ...
                    incrementRisks: {
                        url: API_PREFIX + "organizations/:organizationSlug/projects/:projectSlug/bigpicture/increment/:incrementId/risks",
                        isArray: true,
                        method: 'GET',
                        params: {
                            incrementId: "incrementId",
        ...
        public loadIncrementRisks(projectSlug: string, incrementId: number){
            var p = this.BigPictureApi.incrementRisks({projectSlug: projectSlug, incrementId:incrementId}).$promise;
            return p;
        }
        ...
        public loadRootRisks(portfolioId: number, iterationID:number){
            var p = this.risksManager
                        .loadRisksForIteration(portfolioId, iterationID);
            return p;
        }

        public loadRootSystemRisks(rootSlug:string, iterationID:number){
            var p = this.risksManager
                        .loadIterationSystemRisks(rootSlug, iterationID)
            return p;
        }
