...
module scrumdo{
    ...
    export class BigPictureItrController{
        ...
        private popoverInfoTemplate: string = '';
        ...
        constructor(public $scope: ng.IScope,
            ...
            this.popoverInfoTemplate = this.urlRewriter.rewriteAppUrl("bigpicture/helpinfo.html");
            this.initData();
            ...
            this.workItemName = $scope.$root['safeTerms'] != null ? $scope.$root['safeTerms'].current.work_item_name : "Card";
        }

        onChildIterationUpdated = () => {
            this.projectData.reloadCurrentIncrement();
        ...
        private initData(){
            this.portfolio = cleanPortfolioLevels(this.projectData.portfolio);
            setTimeout(() => {
