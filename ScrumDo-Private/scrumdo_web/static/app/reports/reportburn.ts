...
module scrumdo {
    ...
    class BurndownChart {
        ...
        // public stackedColors = ["#444444", "#448cca", "#ff7f0e", "#8dc73e"];
        ...
        stacked() {
            ...
            var data = [this.scope.reportData.data[1], this.scope.reportData.data[4], this.scope.reportData.data[7], this.scope.reportData.data[10]]

            if (data.length === 0 || this.scope.reportData.data.length === 0 || this.scope.reportData.data[10] == null) {
                this.renderNoData();
                return;
            }
            ...
            // var lastDate = 0;
            // for(var yyyy = 0; yyyy<data[0].data.length; yyyy++) {
            //   var thisDate = data[0].data[yyyy][0];
            //   var p = [];
            //   for(var iiii = 0 ; iiii < 4 ; iiii++) {
            //     console.log(iiii,yyyy)
            //     p.push(data[iiii].data[yyyy][1])
            //     // if(data[iiii].data[yyyy][0] != thisDate) {
            //     //   console.log(`different at ${iiii} ${yyyy}`)
            //     // }
            //   }
            //   // console.log(p.reduce((acc, curr) => {
            //   //   if(acc.indexOf(curr) == -1) { acc.push(curr); }
            //   //   return acc;
            //   // },[]));
            //   console.log(thisDate, p);
            // }
