...
module scrumdo {
    ...
    export class ReportsController {
        ...
        private initData(projectData:ProjectDatastore) {
            ...
            if(this.projectData.currentIteration != null && this.projectData.currentIteration.iteration_type==1){
                this.reportOptions.iteration = this.projectData.currentIteration;
            }else{
        ...
        public selectReport = (uiState, forceLoad:boolean=false) => {
            ...
            if(uiState.indexOf('app.reports') == -1) {
              uiState = 'app.reports.' + uiState;
            }
        ...
        public iterationChanged = () => {
            ...
            if(this.reportOptions.iteration.id == -1){
                this.reportOptions.startdate = null;
                this.reportOptions.enddate = null;
                return;
            }
