...
module scrumdo {
    export class ReportManager {
        ...
        public loadBacklogCFD = (organizationSlug, projectSlug, options) => {
            return this.http({
                url: this.API_PREFIX + "organizations/" + organizationSlug + "/projects/" + projectSlug + "/kstats/backlogcfd/-1",
                method: "GET",
                params: options
            });
        }
        ...
        public loadProjectSentimets = (organizationSlug: string, projectSlug: string) => {
            return this.http({
                url: this.API_PREFIX + "organizations/" + organizationSlug + "/projects/" + projectSlug + "/sentiments/reportdata/" ,
                method: "GET",
                params: null
            });
        }
