...
boardmodule.controller("IterationSettingsController", scrumdo.IterationSettingsController);
boardmodule.controller("ProjectTeamSettingsController", scrumdo.ProjectTeamSettingsController);
boardmodule.controller("BacklogCommonController", scrumdo.BacklogCommonController);
...
boardmodule.directive("sdBacklogCommon", function() {
    return {
        controller: "BacklogCommonController",
        controllerAs: "ctrl",
        templateUrl: STATIC_URL + "app/board/backlogcommon.html",
        scope:{
            portfolio: "<",
            currentProject: "<",
            backlogSlug: "<",
