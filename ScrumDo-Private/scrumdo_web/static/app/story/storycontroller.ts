...
module scrumdo {
    export class StoryController {
        ...
        public sharedViewTemplate: string;
        ...
        constructor(
            ...
            this.templateName = '';
            this.sharedViewTemplate = this.urlRewriter.rewriteAppUrl("story/story_normal.html");
            ...
            if(this.$state.current.name == 'app.iteration.board') {
                this.scope.ctrl.quickUploadAttachment = true;
            }
            ...
            if (this.scope.project) {
                if (this.userService.canWrite(this.scope.project.slug)) {
                    this.scope.$root.ctxmenus = [
                        ...
                        { label: `Move to Workspace/Iteration`, action: 'moveToProject' },
        ...
        findReleaseTeamCards(){
            let release = this.scope.story;
            this.projectSearchManager.orgSearchPopup(`release: ${release.number}, release_prefix: ${this.scope.project.prefix}`);
        }
        ...
        setLayout = () => {
            ...
            this.listLayout = layout === 'list' || layout === 'list_dependency';
        ...
        onMouseOut = (event: MouseEvent) => {
            angular.element('.cards').removeClass('isActive-dropzone');
        }
    }
}
