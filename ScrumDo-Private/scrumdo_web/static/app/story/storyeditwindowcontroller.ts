    ...
    export class StoryEditWindowController {
        ...
        init(newsManager, $sce, user) {
            ...
            if (!this.scope.newStory) {
                ...
                // We won't wait for this since it takes forever for some customers
                // and isn't actually neccessary to view the window
        ...
        save = (event) => {
            ...
            if (this.scope.newStory) {
                ...
                this.story.dependencies = this.dependencies;
                this.story.risks = this.risks;
            }
