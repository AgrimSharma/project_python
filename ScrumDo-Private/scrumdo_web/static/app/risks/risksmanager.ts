...
module scrumdo {
    ...
    export class RisksManager {
        ...
        constructor(private $resource,
            ...
            this.SystemRisks = <SystemRiskResource> this.$resource(API_PREFIX +                         "organizations/:organizationSlug/projects/:projectSlug/systemrisks",
                {
                    organizationSlug: 'organizationSlug',
                ...
                {
                    iterationRisks: {
                        url: API_PREFIX + "organizations/:organizationSlug/projects/:projectSlug/systemrisks/iteration/:iterationId",
                        method: 'GET',
                        isArray: true,
                        params: {
                            organizationSlug: 'organizationSlug',
        ...
        public loadRisksForProject(portfolioId:number, project_slug:string) {
            return this.Risks.query({organizationSlug:this.organizationSlug, portfolioId:portfolioId, projectSlug:project_slug}).$promise
        }

        public loadIterationSystemRisks(projectSlug: string, iterationId:number) : ng.IPromise<any>{
            return this.SystemRisks.iterationRisks({organizationSlug:this.organizationSlug, projectSlug:projectSlug, iterationId:iterationId}).$promise
        }

        public loadSystemRisks(projectSlug: string) : ng.IPromise<any>{
            return this.SystemRisks.query({organizationSlug:this.organizationSlug, projectSlug:projectSlug}).$promise
        }
