...
riskmodule.controller("ProjectRisksController", scrumdo.ProjectRisksController);
...
riskmodule.directive('sdProjectRisks', () => {
    return {
        controller: 'ProjectRisksController',
        controllerAs: 'ctrl',
        templateUrl: STATIC_URL + 'app/risks/projectrisks.html',
        scope:{
            portfolio: "<"
        },
