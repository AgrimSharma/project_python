...
planningmod.controller("PlanningSafeBacklogController", scrumdo.PlanningSafeBacklogController);
...
planningmod.directive("sdPlanningSafeParents", function() {
    return {
        restrict: "E",
        scope: {
            project: "<",
        ...
        templateUrl: STATIC_URL + "app/planning/planningsafeparents.html",
        controller: "PlanningSafeController",
        controllerAs: 'ctrl'
    };
});

planningmod.directive("sdPlanningSafeSibling", function() {
    return {
        restrict: "E",
        scope: {
            project: "<",
        ...
        templateUrl: STATIC_URL + "app/planning/planningsafesibling.html",
        controller: "PlanningSafeController",
        controllerAs: 'ctrl'
    };
});

planningmod.directive("sdPlanningSafeBacklog", function() {
    return {
        restrict: "E",
        scope: {
            project: "<",
        ...
        templateUrl: STATIC_URL + "app/planning/planningsafebacklog.html",
        controller: "PlanningSafeBacklogController",
        controllerAs: 'ctrl'
    };
});
