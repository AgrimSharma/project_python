...
module scrumdo {
    export class FilterBuilderController {
        ...
        private release;
        private currentEpic;
        private currentIterations: Array<Iteration>;
        private assignees;
        private creators;
        private options;
        ...
        constructor(
            ...
            private showIterations: boolean) {
            ...
            if (this.project != null) {
                ...
                this.iterationManager.loadIterations(this.organizationSlug, this.project.slug).then((result) => {
                    this.iterations = _.filter(result, (i: Iteration) => i.iteration_type == 1 );
                });
            }
        ...
        buildQuery() {
            ...
            if(this.currentIterations.length > 0){
                let itr_ids = _.pluck(this.currentIterations, "id");
                query += "iterations: " + itr_ids.join("-") + ", ";
            } 
