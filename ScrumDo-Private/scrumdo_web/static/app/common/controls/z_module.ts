...
mod.controller("ChildrenIterationsController", scrumdo.ChildrenIterationsController)
...
mod.directive("childrenIterationsEditor", () => {
    return {
        restrict: "E",
        templateUrl: STATIC_URL + "app/common/controls/childreniterations.html",
        controller: "ChildrenIterationsController",
        controllerAs: "ctrl",
        scope: {
            parentProject: "<",
            parentIteration: "<",
