...
module scrumdo {
    ...
    export class DependencyGraphController {
        ...
        constructor(private $element, private $scope) {
            ...
            $scope.$on("reRenderDependencyGraph", this.reRenderGraph);
        ...
        private getDepdendencyCoordinates():Array<CurveData> {
            ...
            return this.$scope.dependencies.map((dependency) => {
                ...
                toElement.addClass('has-dependency');
                fromElement.addClass('has-dependency');
                ...
                return {
                    ...
                    sy: fromOff.top - (180-extraMargin) + scrollTop,
                    ex: toOff.left + scrollLeft,
                    ey: toOff.top - (165-extraMargin) + scrollTop
                }
