...
mod.filter("localdate", () => {
    return scrumdo.localdate;
});
...
if (typeof Handlebars !== "undefined" && Handlebars !== null) {
    ...
    Handlebars.registerHelper('localdate', function(date, options) {
        return scrumdo.localdate(date);
    });
