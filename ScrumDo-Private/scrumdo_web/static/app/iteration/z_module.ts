...
iterationmodule.controller('IterationEditorController', scrumdo.IterationEditorController);
iterationmodule.controller("IterationMultiSelectController", scrumdo.IterationMultiSelectController);
iterationmodule.controller("IterationOverviewController", scrumdo.IterationOverviewController);
iterationmodule.controller("IterationProgressViewController", scrumdo.IterationProgressViewController);
iterationmodule.controller("IterationSummarySidebarController", scrumdo.IterationSummarySidebarController);
...
iterationmodule.directive("sdIterationOverview", function() {
    return {
        restrict: "E",
        templateUrl: STATIC_URL + "app/iteration/iterationoverview.html",
        controller: "IterationOverviewController",
        controllerAs: 'ctrl',
        replace: true,
        scope: {
            iteration: "=",
...
iterationmodule.directive("sdIterationEdit", function() {
    return {
        restrict: "E",
        templateUrl: STATIC_URL + "app/iteration/iterationeditor.html",
        controller: "IterationEditorController",
        controllerAs: 'ctrl',
        replace: true,
        scope: {
            iterationCopy: "<",
...
iterationmodule.directive("iterationSummarySidebar", () => {
    return {
        restrict: "E",
        templateUrl: STATIC_URL + "app/iteration/summarysidebar.html",
        controller: "IterationSummarySidebarController",
        controllerAs: 'ctrl',
        replace: true,
        scope: {
            project: '=',
...
iterationmodule.controller("IterationSentimentController", scrumdo.IterationSentimentController);
