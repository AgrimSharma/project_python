        ...
        if (typeof callback === 'function') {
          ...
          callback = function(event) {
            ...
            if (event) {
              ...
              // We do not want to execute in content-editable areas, unless this particular key has
              // been flagged to work in content-editable              
              if(target.contentEditable && target.contentEditable == 'true') {
                  if(allowIn.indexOf("CONTENT-EDITABLE") == -1) {
                      shouldExecute = false;
                  }
              }
