...
from apps.debug_toolbar.panels import DebugPanel
from apps.debug_toolbar.utils import sqlparse
    ...
    def execute(self, sql, params=()):
        ...
        try:
            ...
            self.db.queries.append({
                ...
                'raw_sql': sql,
                'params': _params,
                'hash': hashlib.sha1(settings.SECRET_KEY + sql + _params).hexdigest(),
