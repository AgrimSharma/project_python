...
from apps.projects.models import Project, Iteration, Story, Task
...
class ProjectExtraMapping(models.Model):
    ...
    # configuration = models.TextField(null=True, blank=True, default='')
    class Meta:
...
#
#     class Meta:
#         db_table = "v2_extras_extraconfiguration"
