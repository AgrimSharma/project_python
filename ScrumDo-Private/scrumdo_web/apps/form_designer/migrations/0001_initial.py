...
import apps.form_designer.fields
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail_to', apps.form_designer.fields.TemplateCharField(help_text=b'Separate several addresses with a comma. Your form fields are available as template context. Example: "admin@domain.com, {{ from_email }}" if you have a field named `from_email`.', max_length=255, null=True, verbose_name='send form data to e-mail address', blank=True)),
                ('mail_from', apps.form_designer.fields.TemplateCharField(help_text=b'Your form fields are available as template context. Example: "{{ first_name }} {{ last_name }} <{{ from_email }}>" if you have fields named `first_name`, `last_name`, `from_email`.', max_length=255, null=True, verbose_name='sender address', blank=True)),
                ('mail_subject', apps.form_designer.fields.TemplateCharField(help_text=b'Your form fields are available as template context. Example: "Contact form {{ subject }}" if you have a field named `subject`.', max_length=255, null=True, verbose_name='email subject', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regex', apps.form_designer.fields.RegexpExpressionField(max_length=255, null=True, verbose_name='regular Expression', blank=True)),
                ('choice_model', apps.form_designer.fields.ModelNameField(help_text=b'your_app.models.ModelName', max_length=255, null=True, verbose_name='data model', blank=True)),
