...
function program5(depth0,data) {
  ...
  return "\n                    <div class='sandbox_header'>\n                        <input class='submit' name='commit' type='button' value='Try it out!' />\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img alt='Throbber' class='response_throbber' src='https://d2jyphd0juzwxu.cloudfront.net/static/v0/scrumdo-v2/swagger/images/throbber.gif' style='display:none' />\n                    </div>\n                    ";}
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
        ...
        headerParams["X-CSRFToken"] = getCookie("csrftoken");
    ...
    OperationView.prototype.toggleOperationContent = function() {
      var elem;
	  console.log('#' + this.model.resourceName + "_" + this.model.nickname + "_" + this.model.httpMethod + "_content");
