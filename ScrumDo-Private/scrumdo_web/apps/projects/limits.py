...
class Limit(object) :
    ...
    def featureEnabled(self, **kwargs):
        return self.increaseAllowed(**kwargs)
...
org_planning_poker     = Limit( providing_args=["organization"] )
org_custom_status      = Limit( providing_args=["organization"] )
org_time_tracking      = Limit( providing_args=["organization"] )
org_kanban             = Limit( providing_args=["organization"] )
org_live_updates       = Limit( providing_args=["organization"] )
