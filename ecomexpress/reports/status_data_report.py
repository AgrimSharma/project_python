...
from service_centre.models import Shipment, StatusUpdate, get_internal_shipment_status, ShipmentHistory_2014_03
import settings
import csv
import datetime
...
def data_report(request=None, params=None):
   ...
   #       su = ""
        ...
        hist = ShipmentHistory_2014_03.objects.using('local_ecomm').filter(shipment__airwaybill_number=a[0], status__in=[0,6,7,8,9]).values_list('status','reason_code__code','reason_code__code_description','current_sc__center_shortcode','updated_on')
...
data_report()
os.system('cd /home/web/ecomm.prtouch.com/ecomexpress/static/uploads && zip st_data_report.zip st_data_report.csv')
subject = "Data Report"
message = 'http://billing.ecomexpress.in/static/uploads/st_data_report.zip'
