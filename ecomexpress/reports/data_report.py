...
def data_report(request=None, params=None):
    ...
    today = datetime.datetime.today() - datetime.timedelta(days=datetime.datetime.today().day)
...
to_email = ("samar@prtouch.com","sravank@ecomexpress.in","prashanta@ecomexpress.in","jignesh@prtouch.com","jinesh@prtouch.com","onkar@prtouch.com", "shilpaa@ecomexpress.in", "veenav@ecomexpress.in")
