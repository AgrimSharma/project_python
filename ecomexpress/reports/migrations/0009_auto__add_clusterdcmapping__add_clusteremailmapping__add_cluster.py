...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClusterDCMapping'
        db.create_table('reports_clusterdcmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Cluster'], null=True, blank=True)),
            ('dc_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.ServiceCenter'], null=True, blank=True)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['ClusterDCMapping'])

        # Adding model 'ClusterEmailMapping'
        db.create_table('reports_clusteremailmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Cluster'], null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['ClusterEmailMapping'])

        # Adding model 'Cluster'
        db.create_table('reports_cluster', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cluster_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['Cluster'])


    def backwards(self, orm):
        # Deleting model 'ClusterDCMapping'
        db.delete_table('reports_clusterdcmapping')

        # Deleting model 'ClusterEmailMapping'
        db.delete_table('reports_clusteremailmapping')

        # Deleting model 'Cluster'
        db.delete_table('reports_cluster')
