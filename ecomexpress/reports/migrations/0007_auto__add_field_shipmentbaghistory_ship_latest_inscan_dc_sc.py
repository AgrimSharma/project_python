...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShipmentBagHistory.ship_latest_inscan_dc_sc'
        db.add_column('reports_shipmentbaghistory', 'ship_latest_inscan_dc_sc',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShipmentBagHistory.ship_latest_inscan_dc_sc'
        db.delete_column('reports_shipmentbaghistory', 'ship_latest_inscan_dc_sc')
