...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DaywiseCustomerReport'
        db.create_table('reports_daywisecustomerreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('shipment_count', self.gf('django.db.models.fields.BigIntegerField')()),
            ('shipment_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('reports', ['DaywiseCustomerReport'])

        # Adding model 'GenericQuery_2014_01'
        db.create_table('reports_genericquery_2014_01', (
            ...
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_01', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_01', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_01'])

        # Adding model 'GenericQuery_2014_02'
        db.create_table('reports_genericquery_2014_02', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_02', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_02', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_02'])

        # Adding model 'GenericQuery_2014_03'
        db.create_table('reports_genericquery_2014_03', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_03', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_03', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_03'])

        # Adding model 'GenericQuery_2014_04'
        db.create_table('reports_genericquery_2014_04', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_04', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_04', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_04'])

        # Adding model 'GenericQuery_2014_05'
        db.create_table('reports_genericquery_2014_05', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_05', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_05', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_05'])

        # Adding model 'GenericQuery_2014_06'
        db.create_table('reports_genericquery_2014_06', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_06', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_06', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_06'])

        # Adding model 'GenericQuery_2014_07'
        db.create_table('reports_genericquery_2014_07', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_07', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_07', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_07'])

        # Adding model 'GenericQuery_2014_08'
        db.create_table('reports_genericquery_2014_08', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_08', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_08', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_08'])

        # Adding model 'GenericQuery_2014_09'
        db.create_table('reports_genericquery_2014_09', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_09', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_09', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_09'])

        # Adding model 'GenericQuery_2014_10'
        db.create_table('reports_genericquery_2014_10', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_10', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_10', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_10'])

        # Adding model 'GenericQuery_2014_11'
        db.create_table('reports_genericquery_2014_11', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_11', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_11', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_11'])

        # Adding model 'GenericQuery_2014_12'
        db.create_table('reports_genericquery_2014_12', (
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True, db_index=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ...
            ('first_attempt_status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=80, null=True, blank=True)),
            ('first_attempt_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sub_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcustomer_14_12', null=True, to=orm['customer.Customer'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='generic_destination_14_12', null=True, to=orm['location.ServiceCenter'])),
            ('update_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reports', ['GenericQuery_2014_12'])

        # Adding model 'CustomerRemittance'
        db.create_table('reports_customerremittance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer_code', self.gf('django.db.models.fields.IntegerField')(max_length=7)),
            ('customer_id', self.gf('django.db.models.fields.IntegerField')(max_length=3)),
            ('current_day', self.gf('django.db.models.fields.IntegerField')(max_length=1)),
            ('to_day', self.gf('django.db.models.fields.IntegerField')(max_length=1)),
        ))
        db.send_create_signal('reports', ['CustomerRemittance'])

        # Adding model 'DailyUndeliveredCount'
        db.create_table('reports_dailyundeliveredcount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('undelivered_count', self.gf('django.db.models.fields.BigIntegerField')()),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('reports', ['DailyUndeliveredCount'])

        # Adding model 'ShipmentBagHistory'
        db.create_table('reports_shipmentbaghistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('awb', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
            ('ship_added_on_sc', self.gf('django.db.models.fields.CharField')(max_length=5, db_index=True)),
            ('ship_added_on_time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('ship_original_dest', self.gf('django.db.models.fields.CharField')(max_length=5, db_index=True)),
            ('ship_manifest_dest', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True)),
            ('ship_rts_status', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True)),
            ('ship_shipper_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=30, null=True, blank=True)),
            ('ship_shipper_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ('bag_first_close_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('bag_first_sc_connection_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('bag_first_hub_inscan_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('bag_first_hub_inscan_sc', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True)),
            ('bag_latest_inscan_dc_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('bag_latest_inscan_dc_sc', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True)),
            ('ship_first_status_update_reason_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True)),
            ('ship_first_status_update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('ship_latest_status_update_reason_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True)),
            ('ship_latest_status_update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('ship_rts_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_index=True, blank=True)),
            ('ship_closed_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('ship_remarks', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('ship_misroute_remarks', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ('ship_latest_outscan_emp', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ('current_bag_number', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ('last_removed_bag_number', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ('first_added_bag_number', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ('last_added_bag_number', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('record_update', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('reports', ['ShipmentBagHistory'])


    def backwards(self, orm):
        # Deleting model 'DaywiseCustomerReport'
        db.delete_table('reports_daywisecustomerreport')

        # Deleting model 'GenericQuery_2014_01'
        db.delete_table('reports_genericquery_2014_01')

        # Deleting model 'GenericQuery_2014_02'
        db.delete_table('reports_genericquery_2014_02')

        # Deleting model 'GenericQuery_2014_03'
        db.delete_table('reports_genericquery_2014_03')

        # Deleting model 'GenericQuery_2014_04'
        db.delete_table('reports_genericquery_2014_04')

        # Deleting model 'GenericQuery_2014_05'
        db.delete_table('reports_genericquery_2014_05')

        # Deleting model 'GenericQuery_2014_06'
        db.delete_table('reports_genericquery_2014_06')

        # Deleting model 'GenericQuery_2014_07'
        db.delete_table('reports_genericquery_2014_07')

        # Deleting model 'GenericQuery_2014_08'
        db.delete_table('reports_genericquery_2014_08')

        # Deleting model 'GenericQuery_2014_09'
        db.delete_table('reports_genericquery_2014_09')

        # Deleting model 'GenericQuery_2014_10'
        db.delete_table('reports_genericquery_2014_10')

        # Deleting model 'GenericQuery_2014_11'
        db.delete_table('reports_genericquery_2014_11')

        # Deleting model 'GenericQuery_2014_12'
        db.delete_table('reports_genericquery_2014_12')

        # Deleting model 'CustomerRemittance'
        db.delete_table('reports_customerremittance')

        # Deleting model 'DailyUndeliveredCount'
        db.delete_table('reports_dailyundeliveredcount')

        # Deleting model 'ShipmentBagHistory'
        db.delete_table('reports_shipmentbaghistory')
    ...
    models = {
        ...
        'reports.shipmentbaghistory': {
            ...
            'current_bag_number': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'ship_shipper_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        }
    }
