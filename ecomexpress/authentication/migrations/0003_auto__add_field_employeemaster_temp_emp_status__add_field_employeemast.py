...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeMaster.temp_emp_status'
        db.add_column('authentication_employeemaster', 'temp_emp_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EmployeeMaster.effective_date'
        db.add_column('authentication_employeemaster', 'effective_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmployeeMaster.temp_days'
        db.add_column('authentication_employeemaster', 'temp_days',
                      self.gf('django.db.models.fields.IntegerField')(default=7, max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeMaster.temp_emp_status'
        db.delete_column('authentication_employeemaster', 'temp_emp_status')

        # Deleting field 'EmployeeMaster.effective_date'
        db.delete_column('authentication_employeemaster', 'effective_date')

        # Deleting field 'EmployeeMaster.temp_days'
        db.delete_column('authentication_employeemaster', 'temp_days')
