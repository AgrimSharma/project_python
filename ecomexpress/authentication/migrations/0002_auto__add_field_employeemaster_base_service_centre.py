...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeMaster.base_service_centre'
        db.add_column('authentication_employeemaster', 'base_service_centre',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='emp_base_sc', null=True, to=orm['location.ServiceCenter']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeMaster.base_service_centre'
        db.delete_column('authentication_employeemaster', 'base_service_centre_id')
