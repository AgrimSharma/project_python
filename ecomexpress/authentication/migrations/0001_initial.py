...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('authentication_department', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('authentication', ['Department'])

        # Adding model 'EmployeeMaster'
        db.create_table('authentication_employeemaster', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('user_type', self.gf('django.db.models.fields.CharField')(default='Staff', max_length=15, blank=True)),
            ...
            ('address3', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('service_centre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.ServiceCenter'], null=True, blank=True)),
            ('mobile_no', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentication.Department'])),
            ('login_active', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2)),
            ('staff_status', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2)),
            ('allow_concurent_login', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2, null=True, blank=True)),
            ('query_limit', self.gf('django.db.models.fields.IntegerField')(default=50, max_length=5, null=True, blank=True)),
            ('ebs', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ebs_customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Customer'], null=True, blank=True)),
        ))
        db.send_create_signal('authentication', ['EmployeeMaster'])

        # Adding model 'EmployeeMasterCustomer'
        db.create_table('authentication_employeemastercustomer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Customer'])),
            ('employee_master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentication.EmployeeMaster'])),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('authentication', ['EmployeeMasterCustomer'])

        # Adding model 'PasswordPeriod'
        db.create_table('authentication_passwordperiod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentication.EmployeeMaster'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('authentication', ['PasswordPeriod'])


    def backwards(self, orm):
        # Deleting model 'Department'
        db.delete_table('authentication_department')

        # Deleting model 'EmployeeMaster'
        db.delete_table('authentication_employeemaster')

        # Deleting model 'EmployeeMasterCustomer'
        db.delete_table('authentication_employeemastercustomer')

        # Deleting model 'PasswordPeriod'
        db.delete_table('authentication_passwordperiod')
    ...
    models = {
        ...
        'authentication.employeemastercustomer': {
            'Meta': {'object_name': 'EmployeeMasterCustomer'},
            'added_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customer.Customer']"}),
            'employee_master': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['authentication.EmployeeMaster']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'authentication.passwordperiod': {
            'Meta': {'object_name': 'PasswordPeriod'},
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['authentication.EmployeeMaster']"})
        },
