...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShipmentDamageStatus.sold_date'
        db.add_column('damageshipment_shipmentdamagestatus', 'sold_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShipmentDamageStatus.sold_date'
        db.delete_column('damageshipment_shipmentdamagestatus', 'sold_date')
