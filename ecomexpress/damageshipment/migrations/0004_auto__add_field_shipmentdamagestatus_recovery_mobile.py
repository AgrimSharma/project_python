...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShipmentDamageStatus.recovery_mobile'
        db.add_column('damageshipment_shipmentdamagestatus', 'recovery_mobile',
                      self.gf('django.db.models.fields.IntegerField')(max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShipmentDamageStatus.recovery_mobile'
        db.delete_column('damageshipment_shipmentdamagestatus', 'recovery_mobile')
    ...
    models = {
        ...
        'damageshipment.shipmentdamagestatus': {
            ...
            'recovery_mobile': ('django.db.models.fields.IntegerField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
