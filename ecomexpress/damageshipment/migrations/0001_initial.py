...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShipmentDamageStatus'
        db.create_table('damageshipment_shipmentdamagestatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service_centre.Shipment'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1, db_index=True)),
            ('recovered_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('recovery_from', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recovery_address', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('recovery_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('recovery_mobile', self.gf('django.db.models.fields.IntegerField')(max_length=12)),
            ('actual_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('recovery_recipt_number', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('employee_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentication.EmployeeMaster'])),
        ))
        db.send_create_signal('damageshipment', ['ShipmentDamageStatus'])


    def backwards(self, orm):
        # Deleting model 'ShipmentDamageStatus'
        db.delete_table('damageshipment_shipmentdamagestatus')
    ...
    models = {
        ...
        'damageshipment.shipmentdamagestatus': {
            'Meta': {'object_name': 'ShipmentDamageStatus'},
            'actual_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'added_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'employee_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['authentication.EmployeeMaster']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recovered_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'recovery_address': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'recovery_from': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'recovery_mobile': ('django.db.models.fields.IntegerField', [], {'max_length': '12'}),
            'recovery_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'recovery_recipt_number': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
