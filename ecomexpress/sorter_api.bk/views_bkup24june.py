...
def create_update_vendor(request):
    ...
    if request.POST:
        ...
        pincode = Pincode.objects.filter(pincode = request.POST.get("pincode"))
        if not pincode :
        ...
        sub_customer = Shipper.objects.filter(customer=customer, alias_code=request.POST.get("vendor_code"))
        if not sub_customer :
            address = Address.objects.create(address1 = request.POST.get("address1"), pincode = pincode, city=pincode.service_center.city, state=pincode.service_center.city.state)
            if request.POST.get("address2"):
                address.address2 = request.POST.get("address2") 
            if request.POST.get("address3"):
                address.address3 = request.POST.get("address3") 
            if request.POST.get("address4"):
                address.address2 = request.POST.get("address4") 
            if request.POST.get("phone"):
                address.phone = request.POST.get("phone") 
            address.save()
            sub_customer = Shipper.objects.create(customer=customer, alias_code=request.POST.get("vendor_id"), name = request.POST.get("name"), address=address)
        else:
            ...
            sub_customer.name = request.POST.get("name")
            sub_customer.save()
