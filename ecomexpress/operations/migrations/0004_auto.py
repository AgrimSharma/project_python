...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ConsolidatedBagCollection', fields ['status']
        db.create_index('operations_consolidatedbagcollection', ['status'])

        # Adding index on 'ConsolidatedBagCollection', fields ['created']
        db.create_index('operations_consolidatedbagcollection', ['created'])

        # Adding index on 'ConsolidatedBagCollection', fields ['modified']
        db.create_index('operations_consolidatedbagcollection', ['modified'])

        # Adding index on 'ConsolidatedBag', fields ['status']
        db.create_index('operations_consolidatedbag', ['status'])

        # Adding index on 'ConsolidatedBag', fields ['bag_number']
        db.create_index('operations_consolidatedbag', ['bag_number'])

        # Adding index on 'ConsolidatedBag', fields ['created']
        db.create_index('operations_consolidatedbag', ['created'])

        # Adding index on 'ConsolidatedBag', fields ['modified']
        db.create_index('operations_consolidatedbag', ['modified'])

        # Adding index on 'ConsolidatedBagConnection', fields ['status']
        db.create_index('operations_consolidatedbagconnection', ['status'])

        # Adding index on 'ConsolidatedBagConnection', fields ['created']
        db.create_index('operations_consolidatedbagconnection', ['created'])

        # Adding index on 'ConsolidatedBagConnection', fields ['modified']
        db.create_index('operations_consolidatedbagconnection', ['modified'])


    def backwards(self, orm):
        # Removing index on 'ConsolidatedBagConnection', fields ['modified']
        db.delete_index('operations_consolidatedbagconnection', ['modified'])

        # Removing index on 'ConsolidatedBagConnection', fields ['created']
        db.delete_index('operations_consolidatedbagconnection', ['created'])

        # Removing index on 'ConsolidatedBagConnection', fields ['status']
        db.delete_index('operations_consolidatedbagconnection', ['status'])

        # Removing index on 'ConsolidatedBag', fields ['modified']
        db.delete_index('operations_consolidatedbag', ['modified'])

        # Removing index on 'ConsolidatedBag', fields ['created']
        db.delete_index('operations_consolidatedbag', ['created'])

        # Removing index on 'ConsolidatedBag', fields ['bag_number']
        db.delete_index('operations_consolidatedbag', ['bag_number'])

        # Removing index on 'ConsolidatedBag', fields ['status']
        db.delete_index('operations_consolidatedbag', ['status'])

        # Removing index on 'ConsolidatedBagCollection', fields ['modified']
        db.delete_index('operations_consolidatedbagcollection', ['modified'])

        # Removing index on 'ConsolidatedBagCollection', fields ['created']
        db.delete_index('operations_consolidatedbagcollection', ['created'])

        # Removing index on 'ConsolidatedBagCollection', fields ['status']
        db.delete_index('operations_consolidatedbagcollection', ['status'])
    ...
    models = {
        ...
        'operations.consolidatedbag': {
            ...
            'bag_number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
