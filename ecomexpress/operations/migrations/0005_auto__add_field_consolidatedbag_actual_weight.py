...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsolidatedBag.actual_weight'
        db.add_column('operations_consolidatedbag', 'actual_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsolidatedBag.actual_weight'
        db.delete_column('operations_consolidatedbag', 'actual_weight')
    ...
    models = {
        ...
        'operations.consolidatedbag': {
            ...
            'actual_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
