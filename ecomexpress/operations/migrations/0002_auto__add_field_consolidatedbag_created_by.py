...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsolidatedBag.created_by'
        db.add_column('operations_consolidatedbag', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2638, to=orm['authentication.EmployeeMaster']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsolidatedBag.created_by'
        db.delete_column('operations_consolidatedbag', 'created_by_id')
    ...
    models = {
        ...
        'operations.consolidatedbag': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'default': '2638', 'to': "orm['authentication.EmployeeMaster']"}),
