...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConsolidatedBag'
        db.create_table('operations_consolidatedbag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('bag_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('origin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.ServiceCenter'])),
            ('hub', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='consolidated_bag_hub', null=True, to=orm['location.ServiceCenter'])),
            ('current_sc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consolidated_bag_current_sc', to=orm['location.ServiceCenter'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consolidated_bag_dest', to=orm['location.ServiceCenter'])),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal('operations', ['ConsolidatedBag'])

        # Adding model 'ConsolidatedBagCollection'
        db.create_table('operations_consolidatedbagcollection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal('operations', ['ConsolidatedBagCollection'])


    def backwards(self, orm):
        # Deleting model 'ConsolidatedBag'
        db.delete_table('operations_consolidatedbag')

        # Deleting model 'ConsolidatedBagCollection'
        db.delete_table('operations_consolidatedbagcollection')
