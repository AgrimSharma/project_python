...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductItemMaster'
        db.create_table('product_master_productitemmaster', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product_description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('product_weight', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ('product_height', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
            ('product_breadth', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('product_length', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('squ_id', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Customer'])),
        ))
        db.send_create_signal('product_master', ['ProductItemMaster'])


    def backwards(self, orm):
        # Deleting model 'ProductItemMaster'
        db.delete_table('product_master_productitemmaster')
    ...
    models = {
        ...
        'product_master.productitemmaster': {
            'Meta': {'object_name': 'ProductItemMaster'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customer.Customer']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product_breadth': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'product_description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'product_height': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True', 'blank': 'True'}),
            'product_length': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'product_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True', 'blank': 'True'}),
            'squ_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True'})
        }
    }

    complete_apps = ['product_master']