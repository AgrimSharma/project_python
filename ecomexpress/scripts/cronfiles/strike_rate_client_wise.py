...
def strike_rate_analysis():
    scs = Customer.objects.filter().order_by("name")
...
def strike_rate_analysis_report():
    ...
    print file_name
    send_mail('Client Strike Rate Analysis',
              "Dear Team,\n Client Strike Rate Analysis by Client report has been generated. Please find the link below.\n http://cs.ecomexpress.in/static/uploads{0}\n\n".format(file_name),
