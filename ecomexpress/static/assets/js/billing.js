$(document).ready(function(){
    ...
    var submit_provisional_form_original = function(){
    ...
    var submit_provisional_form = _.throttle(submit_provisional_form_original, 10000);
    ...
    var update_provisional_reports_original = function(){
        $.ajax({
    ...
    var update_provisional_reports = _.throttle(update_provisional_reports_original, 10000);
    ...
    // Billing Section
    var submit_billing_form_original = function(form_hash, url){
        var form = form_hash;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    var submit_billing_form = _.throttle(submit_billing_form_original, 10000);
    ...
    var update_billing_reports_original = function(){
        $.ajax({
    ...
    var update_billing_reports = _.throttle(update_billing_reports_original, 10000);
    ...
    var update_customer_reports_original = function(queue_id){
        $.ajax({
    ...
    var update_customer_reports = _.throttle(update_customer_reports_original, 10000);
    ...
    $(document).on("click", "#id_generate_bill_reports_form", function(e){
        e.preventDefault();
        // if (validate_form()) submit_billing_form("#id_bill_generation_form", "/billing/generate/");
        submit_billing_form("#id_bill_report_form", "/billing/request_reports/");
    });
});
