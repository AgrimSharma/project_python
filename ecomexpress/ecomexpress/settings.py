...
DEFAULT_FROM_EMAIL='support@ecomexpress.com'
...
DATABASES = {
    'default': {
     ...
     'local_ecomm': {
        ...
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'root12',                  # Not used with sqlite3.
        'HOST': '',       #to be removed for local reading               # Set to empty string for localhost. Not used with sqlite3.
       #'USER': 'ecommprtouch',                      # Not used with sqlite3.
       #'PASSWORD': 'e1c2o3m4r1e2p3o4r5!',                  # Not used with sqlite3.
       #'HOST': '54.164.140.76',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to e
...
TEMPLATE_DIRS = (
     os.path.join(PROJECT_ROOT,'ecomexpress/templates')            
