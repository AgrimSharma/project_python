...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AMZShipment'
        db.create_table('amazon_api_amzshipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service_centre.Shipment'])),
            ('message_refernce_num', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('CarrierTrackingNum', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('amazon_reference_number', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('transport_mode', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('refernce_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('amazon_api', ['AMZShipment'])

        # Adding model 'AMZShipmentSatus'
        db.create_table('amazon_api_amzshipmentsatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status_code', self.gf('django.db.models.fields.CharField')(max_length=5, db_index=True)),
            ('amz_reason_code', self.gf('django.db.models.fields.CharField')(max_length=5, db_index=True)),
            ('amz_status_code', self.gf('django.db.models.fields.CharField')(max_length=5, db_index=True)),
        ))
        db.send_create_signal('amazon_api', ['AMZShipmentSatus'])


    def backwards(self, orm):
        # Deleting model 'AMZShipment'
        db.delete_table('amazon_api_amzshipment')

        # Deleting model 'AMZShipmentSatus'
        db.delete_table('amazon_api_amzshipmentsatus')


    models = {
        'amazon_api.amzshipment': {
            'CarrierTrackingNum': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'Meta': {'object_name': 'AMZShipment'},
            'amazon_reference_number': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_refernce_num': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'refernce_id': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['service_centre.Shipment']"}),
            'transport_mode': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'amazon_api.amzshipmentsatus': {
            'Meta': {'object_name': 'AMZShipmentSatus'},
            'amz_reason_code': ('django.db.models.fields.CharField', [], {'max_length': '5', 'db_index': 'True'}),
            'amz_status_code': ('django.db.models.fields.CharField', [], {'max_length': '5', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status_code': ('django.db.models.fields.CharField', [], {'max_length': '5', 'db_index': 'True'})
        },
