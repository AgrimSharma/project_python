...
def generate_invoice_pdf(bill_id, new_invoice_id=None, with_header=True, bill_date='1-Nov-2014'):
    ...
    table_data = [['Invoice number', new_invoice_id],
	          ['Date', bill_date]]
    ...
    manpower_data = [[Paragraph('''<para><b>Pick up-Origin</b></para>''', styles['LeftHeading']), Paragraph('''<para><b>1/Oct/2014</b></para>''', styles['RightHeading']), Paragraph('''<para><b>TOTAL</b></para>''', styles['RightHeading'])],
		     ['NOIDA', '1', '1'],
		     ['', '-', '-'],
		     ['', '-', '-'],
		     ['', '-', '-'],
