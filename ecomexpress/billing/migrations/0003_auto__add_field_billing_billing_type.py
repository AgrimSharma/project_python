...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Billing.billing_type'
        db.add_column('billing_billing', 'billing_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Billing.billing_type'
        db.delete_column('billing_billing', 'billing_type')
