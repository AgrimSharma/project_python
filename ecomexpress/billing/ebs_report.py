...
def generate_invoice_pdf(bill_id, with_header=True):
    ...
    total_table = Table([[
        ...
        Paragraph('''<para><b>3,524,583.76</b></para>''', styles['bold_right'])]], colWidths=(350, 100))
    ...
    rsword_para = '''
	    <para>
	    Rs. Forty Two Lakh Twenty Seven Thousand Nine Hundred Twenty Six<br/>
	    only
	    </para>
	    '''
    ...
    manpower_data = [[Paragraph('''<para><b>Pick up-Origin</b></para>''', styles['LeftHeading']), Paragraph('''<para><b>1/Jun/2014</b></para>''', styles['RightHeading']), Paragraph('''<para><b>TOTAL</b></para>''', styles['RightHeading'])],
		     ['NOIDA', '1', '1'],
		     ['', '-', '-'],
		     ['', '-', '-'],
		     ['', '-', '-'],
