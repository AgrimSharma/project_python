...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerBillingReport.billing'
        db.add_column('billing_customerbillingreport', 'billing',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['billing.Billing']),
                      keep_default=False)

        # Adding field 'CustomerBillingReport.bill_type'
        db.add_column('billing_customerbillingreport', 'bill_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'CustomerBillingReport', fields ['customer', 'billqueue', 'billing']
        db.create_unique('billing_customerbillingreport', ['customer_id', 'billqueue_id', 'billing_id'])


        # Changing field 'BackdatedBatch.product_type'
        db.alter_column('billing_backdatedbatch', 'product_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True))

        # Changing field 'BackdatedBatch.dest_zone'
        db.alter_column('billing_backdatedbatch', 'dest_zone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['location.Zone']))

        # Changing field 'BackdatedBatch.org_zone'
        db.alter_column('billing_backdatedbatch', 'org_zone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['location.Zone']))

        # Changing field 'BackdatedShipmentBillingQueue.product_type'
        db.alter_column('billing_backdatedshipmentbillingqueue', 'product_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'], null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'CustomerBillingReport', fields ['customer', 'billqueue', 'billing']
        db.delete_unique('billing_customerbillingreport', ['customer_id', 'billqueue_id', 'billing_id'])

        # Deleting field 'CustomerBillingReport.billing'
        db.delete_column('billing_customerbillingreport', 'billing_id')

        # Deleting field 'CustomerBillingReport.bill_type'
        db.delete_column('billing_customerbillingreport', 'bill_type')


        # Changing field 'BackdatedBatch.product_type'
        db.alter_column('billing_backdatedbatch', 'product_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customer.Product']))

        # Changing field 'BackdatedBatch.dest_zone'
        db.alter_column('billing_backdatedbatch', 'dest_zone_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['location.Zone']))

        # Changing field 'BackdatedBatch.org_zone'
        db.alter_column('billing_backdatedbatch', 'org_zone_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['location.Zone']))

        # Changing field 'BackdatedShipmentBillingQueue.product_type'
        db.alter_column('billing_backdatedshipmentbillingqueue', 'product_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customer.Product']))
