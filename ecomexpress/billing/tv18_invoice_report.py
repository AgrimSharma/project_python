...
def generate_invoice_pdf(bill_id, invoice_number, with_header=True):
    ...
    bill_date = (billing.billing_date + datetime.timedelta(days=1)).strftime('%d-%b-%Y')
