...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bag_shipment_table.current_sc'
        db.add_column('hub_bag_shipment_table', 'current_sc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.ServiceCenter'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bag_shipment_table.current_sc'
        db.delete_column('hub_bag_shipment_table', 'current_sc_id')
