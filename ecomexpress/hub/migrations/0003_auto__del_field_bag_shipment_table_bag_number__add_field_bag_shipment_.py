...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bag_shipment_table.bag_number'
        db.delete_column('hub_bag_shipment_table', 'bag_number')

        # Adding field 'Bag_shipment_table.scanned_bag_number'
        db.add_column('hub_bag_shipment_table', 'scanned_bag_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20),
                      keep_default=False)

        # Adding field 'Bag_shipment_table.original_bag_number'
        db.add_column('hub_bag_shipment_table', 'original_bag_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Bag_shipment_table.bag_number'
        db.add_column('hub_bag_shipment_table', 'bag_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20),
                      keep_default=False)

        # Deleting field 'Bag_shipment_table.scanned_bag_number'
        db.delete_column('hub_bag_shipment_table', 'scanned_bag_number')

        # Deleting field 'Bag_shipment_table.original_bag_number'
        db.delete_column('hub_bag_shipment_table', 'original_bag_number')
