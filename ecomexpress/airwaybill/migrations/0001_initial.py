...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AirwaybillNumbers'
        db.create_table('airwaybill_airwaybillnumbers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('airwaybill_number', self.gf('django.db.models.fields.BigIntegerField')(unique=True)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('airwaybill', ['AirwaybillNumbers'])

        # Adding model 'AirwaybillCustomer'
        db.create_table('airwaybill_airwaybillcustomer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('airwaybill', ['AirwaybillCustomer'])

        # Adding M2M table for field airwaybill_number on 'AirwaybillCustomer'
        db.create_table('airwaybill_airwaybillcustomer_airwaybill_number', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('airwaybillcustomer', models.ForeignKey(orm['airwaybill.airwaybillcustomer'], null=False)),
            ('airwaybillnumbers', models.ForeignKey(orm['airwaybill.airwaybillnumbers'], null=False))
        ))
        db.create_unique('airwaybill_airwaybillcustomer_airwaybill_number', ['airwaybillcustomer_id', 'airwaybillnumbers_id'])

        # Adding model 'PPD'
        db.create_table('airwaybill_ppd', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('airwaybill', ['PPD'])

        # Adding model 'PPDZero'
        db.create_table('airwaybill_ppdzero', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('airwaybill', ['PPDZero'])

        # Adding model 'COD'
        db.create_table('airwaybill_cod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('airwaybill', ['COD'])

        # Adding model 'CODZero'
        db.create_table('airwaybill_codzero', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('airwaybill', ['CODZero'])

        # Adding model 'ReversePickup'
        db.create_table('airwaybill_reversepickup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('airwaybill', ['ReversePickup'])


    def backwards(self, orm):
        # Deleting model 'AirwaybillNumbers'
        db.delete_table('airwaybill_airwaybillnumbers')

        # Deleting model 'AirwaybillCustomer'
        db.delete_table('airwaybill_airwaybillcustomer')

        # Removing M2M table for field airwaybill_number on 'AirwaybillCustomer'
        db.delete_table('airwaybill_airwaybillcustomer_airwaybill_number')

        # Deleting model 'PPD'
        db.delete_table('airwaybill_ppd')

        # Deleting model 'PPDZero'
        db.delete_table('airwaybill_ppdzero')

        # Deleting model 'COD'
        db.delete_table('airwaybill_cod')

        # Deleting model 'CODZero'
        db.delete_table('airwaybill_codzero')

        # Deleting model 'ReversePickup'
        db.delete_table('airwaybill_reversepickup')
