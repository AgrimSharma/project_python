...
class FreightSlabCity(models.Model):
    ...
    effective_date = models.DateTimeField(null=True,blank=True, db_index=True)
...
#class FreightSlabZoneV1(models.Model):
...
class CODFreightSlabZone(models.Model):
    ...
    product = models.ManyToManyField(Product, blank=True, null=True)
    def __unicode__(self):
        return  self.customer.name + " - Mode: " + str(self.mode)  + " - Slab: " + str(self.slab)  + " gms - DefaultRate: INR" + str(self.weight_rate) + " - Start: " + str(self.range_from) + " gms - End: " + " - ORG Zone: " + self.zone_org.zone_name + " - DEST Zone: " + self.zone_dest.zone_name + " - Rate: " +  str(self.rate_per_slab)
...
class RTSFreightSlabZone(models.Model):
    ...
    product = models.ManyToManyField(Product, blank=True, null=True)
    def __unicode__(self):
        return str(self.customer) + " - ORG Zone: " + self.zone_org.zone_name + " - DEST Zone: " + self.zone_dest.zone_name + " - Rate: " +  str(self.rate_per_slab)
