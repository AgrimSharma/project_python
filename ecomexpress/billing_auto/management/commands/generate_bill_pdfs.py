...
class Command(BaseCommand):
    ...
    def start_pdf_generation(self, year, month):
        ...
        start_bill_thread_billpdf(bills_list) # this will generate invoice summary reports for all customers
        #start_bill_thread_awbexcel(bills_list) # this will generate airwaybill wise detailed excel report for all customers
