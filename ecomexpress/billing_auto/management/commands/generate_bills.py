...
from billing.product_billing_update import update_productbilling_for_month
...
class Command(BaseCommand):
    ...
    def generate_bills(self, year, month, to_date=None):
        ...
        customer_codes = list(Customer.objects.exclude(code=92006).values_list('code', flat=True))
        ...
        generate_bill_for_jasper(year, month)
        fwd_bill_id, rev_bill_id = update_productbilling_for_month(year, month)
    ...
    def send_summary_mail(self, bill_summary_file):
        ...
        send_mail('Bill Summary file Generated', msg, 'jignesh@prtouch.com',
                  ('jignesh@prtouch.com', 'jinesh@prtouch.com', 'samar@prtouch.com', 'jaideeps@ecomexpress.in', 'anshula@ecomexpress.in'))
                  #'satyak@ecomexpress.in', 'anushla@ecomexpress.in', 'nareshb@ecomexpress.in', 'jitendrad@ecomexpress.in'))
        print 'mail has send...'
