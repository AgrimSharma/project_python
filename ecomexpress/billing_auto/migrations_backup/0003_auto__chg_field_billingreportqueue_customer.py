...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillingReportQueue.customer'
        db.alter_column('billing_billingreportqueue', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Customer'], null=True))

    def backwards(self, orm):

        # Changing field 'BillingReportQueue.customer'
        db.alter_column('billing_billingreportqueue', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Customer']))
