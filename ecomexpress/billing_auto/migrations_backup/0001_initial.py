...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('billing_backdatedbatch', (
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Customer'])),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Product'])),
            ('org_zone', self.gf('django.db.models.fields.related.ForeignKey')(related_name='back_dated_org_zone', to=orm['location.Zone'])),
            ('dest_zone', self.gf('django.db.models.fields.related.ForeignKey')(related_name='back_dated_dest_zone', to=orm['location.Zone'])),
    ...
    models = {
        ...
        'billing.backdatedbatch': {
            ...
            'dest_zone': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'back_dated_dest_zone'", 'to': "orm['location.Zone']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'org_zone': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'back_dated_org_zone'", 'to': "orm['location.Zone']"}),
        ...
        'billing.customerbillingreport': {
            'Meta': {'object_name': 'CustomerBillingReport'},
