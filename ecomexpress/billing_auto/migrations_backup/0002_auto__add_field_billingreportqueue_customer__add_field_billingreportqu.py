...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillingReportQueue.customer'
        db.add_column('billing_billingreportqueue', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['customer.Customer']),
                      keep_default=False)

        # Adding field 'BillingReportQueue.invoice_report'
        db.add_column('billing_billingreportqueue', 'invoice_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BillingReportQueue.headless_invoice_report'
        db.add_column('billing_billingreportqueue', 'headless_invoice_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BillingReportQueue.awb_pdf_report'
        db.add_column('billing_billingreportqueue', 'awb_pdf_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BillingReportQueue.awb_excel_report'
        db.add_column('billing_billingreportqueue', 'awb_excel_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BillingReportQueue.ebs_invoice_report'
        db.add_column('billing_billingreportqueue', 'ebs_invoice_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BillingReportQueue.headless_ebs_invoice_report'
        db.add_column('billing_billingreportqueue', 'headless_ebs_invoice_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BillingReportQueue.summary'
        db.add_column('billing_billingreportqueue', 'summary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BillingReportQueue.msr'
        db.add_column('billing_billingreportqueue', 'msr',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillingReportQueue.customer'
        db.delete_column('billing_billingreportqueue', 'customer_id')

        # Deleting field 'BillingReportQueue.invoice_report'
        db.delete_column('billing_billingreportqueue', 'invoice_report')

        # Deleting field 'BillingReportQueue.headless_invoice_report'
        db.delete_column('billing_billingreportqueue', 'headless_invoice_report')

        # Deleting field 'BillingReportQueue.awb_pdf_report'
        db.delete_column('billing_billingreportqueue', 'awb_pdf_report')

        # Deleting field 'BillingReportQueue.awb_excel_report'
        db.delete_column('billing_billingreportqueue', 'awb_excel_report')

        # Deleting field 'BillingReportQueue.ebs_invoice_report'
        db.delete_column('billing_billingreportqueue', 'ebs_invoice_report')

        # Deleting field 'BillingReportQueue.headless_ebs_invoice_report'
        db.delete_column('billing_billingreportqueue', 'headless_ebs_invoice_report')

        # Deleting field 'BillingReportQueue.summary'
        db.delete_column('billing_billingreportqueue', 'summary')

        # Deleting field 'BillingReportQueue.msr'
        db.delete_column('billing_billingreportqueue', 'msr')
    ...
    models = {
        ...
        'billing.billingreportqueue': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['customer.Customer']"}),
