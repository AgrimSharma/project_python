...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProvisionalProductBilling.billing'
        db.alter_column('billing_provisionalproductbilling', 'billing_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.BillingPreview']))

    def backwards(self, orm):

        # Changing field 'ProvisionalProductBilling.billing'
        db.alter_column('billing_provisionalproductbilling', 'billing_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Billing']))
