...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PickupEnroll.shipper'
        db.add_column('integration_services_pickupenroll', 'shipper',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pickup_enroll', to=orm['customer.Shipper']),
                      keep_default=False)


        # Changing field 'PickupEnroll.employee'
        db.alter_column('integration_services_pickupenroll', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentication.EmployeeMaster'], null=True))

        # Changing field 'PickupEnroll.return_subcustomer'
        db.alter_column('integration_services_pickupenroll', 'return_subcustomer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Shipper'], null=True))

    def backwards(self, orm):
        # Deleting field 'PickupEnroll.shipper'
        db.delete_column('integration_services_pickupenroll', 'shipper_id')


        # Changing field 'PickupEnroll.employee'
        db.alter_column('integration_services_pickupenroll', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['authentication.EmployeeMaster']))

        # Changing field 'PickupEnroll.return_subcustomer'
        db.alter_column('integration_services_pickupenroll', 'return_subcustomer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customer.Shipper']))
    ...
    models = {
        ...
        'integration_services.pickupenroll': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customer.Customer']"}),
            'delivery_service_centre': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['location.ServiceCenter']"}),
            ...
            'return_subcustomer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customer.Shipper']", 'null': 'True', 'blank': 'True'}),
            'shipment_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'shipper': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pickup_enroll'", 'to': "orm['customer.Shipper']"}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'vendor_name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'location.address': {
