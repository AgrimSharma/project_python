...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PickupEnroll.pincode'
        db.alter_column('integration_services_pickupenroll', 'pincode', self.gf('django.db.models.fields.CharField')(default=1, max_length=10))

    def backwards(self, orm):

        # Changing field 'PickupEnroll.pincode'
        db.alter_column('integration_services_pickupenroll', 'pincode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
