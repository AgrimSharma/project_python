...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PickupEnroll.created_by'
        db.add_column('integration_services_pickupenroll', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pickup_enroll', to=orm['authentication.EmployeeMaster']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PickupEnroll.created_by'
        db.delete_column('integration_services_pickupenroll', 'created_by_id')
    ...
    models = {
        ...
        'integration_services.pickupenroll': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pickup_enroll'", 'to': "orm['authentication.EmployeeMaster']"}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customer.Customer']"}),
