...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FetchAirwayBillBatch'
        db.create_table('integration_services_fetchairwaybillbatch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('employee_code', self.gf('django.db.models.fields.CharField')(default=0, max_length=100, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True, blank=True)),
            ('total_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True, blank=True)),
            ('processed_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True, blank=True)),
            ('correct_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True, blank=True)),
            ('not_found_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
            ('pincode', self.gf('django.db.models.fields.CharField')(default=0, max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('integration_services', ['FetchAirwayBillBatch'])

        # Adding model 'FetchAirwayBill'
        db.create_table('integration_services_fetchairwaybill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fetch_airwaybill_batch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['integration_services.FetchAirwayBillBatch'])),
            ('airwaybill_number', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('integration_services', ['FetchAirwayBill'])

        # Adding model 'PickupEnroll'
        db.create_table('integration_services_pickupenroll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customer.Customer'])),
            ('vendor_location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('manifest_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('address', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('pincode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('shipment_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('service_centre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.ServiceCenter'])),
            ('request_source', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
        ))
        db.send_create_signal('integration_services', ['PickupEnroll'])


    def backwards(self, orm):
        # Deleting model 'FetchAirwayBillBatch'
        db.delete_table('integration_services_fetchairwaybillbatch')

        # Deleting model 'FetchAirwayBill'
        db.delete_table('integration_services_fetchairwaybill')

        # Deleting model 'PickupEnroll'
        db.delete_table('integration_services_pickupenroll')
