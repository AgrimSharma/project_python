...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PickupEnroll.vendor_location'
        db.delete_column('integration_services_pickupenroll', 'vendor_location')

        # Deleting field 'PickupEnroll.service_centre'
        db.delete_column('integration_services_pickupenroll', 'service_centre_id')

        # Adding field 'PickupEnroll.vendor_name'
        db.add_column('integration_services_pickupenroll', 'vendor_name',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=100),
                      keep_default=False)

        # Adding field 'PickupEnroll.delivery_service_centre'
        db.add_column('integration_services_pickupenroll', 'delivery_service_centre',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['location.ServiceCenter']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PickupEnroll.vendor_location'
        db.add_column('integration_services_pickupenroll', 'vendor_location',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PickupEnroll.service_centre'
        db.add_column('integration_services_pickupenroll', 'service_centre',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['location.ServiceCenter']),
                      keep_default=False)

        # Deleting field 'PickupEnroll.vendor_name'
        db.delete_column('integration_services_pickupenroll', 'vendor_name')

        # Deleting field 'PickupEnroll.delivery_service_centre'
        db.delete_column('integration_services_pickupenroll', 'delivery_service_centre_id')
