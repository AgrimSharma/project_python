...
def subcust_check(xml_dict):
    error_list = {}
    subcustomers_list = [] 
    for record in xml_dict:
        airwaybill_num = record["AWB_NUMBER"]
        sub_customer_id = recrd["VENDOR_ID"]
        #if Shipper.objects.filter(id=sub_customer_id, customer = capi.customer):
        if Shipper.objects.filter(id=sub_customer_id):
           ...
           if not sub_customer in subcustomers_list:
                ...
                if not error_list.get(airwaybill_num):
                      error_list[airwaybill_num] = {}
                      error_list[airwaybill_num]["vendor"] = "Subcustomer not found! Please check again."
    if not error_list:
...
#                return HttpResponse("%s"%"Invalid Request")
    if 1 == 1:
            ...
            xmlshipments = '''<?xml version="1.0" encoding="UTF-8" standalone="no"?><ECOMEXPRESS-OBJECTS><SHIPMENT>
                           <AWB_NUMBER>103085370</AWB_NUMBER><ORDER_NUMBER>1234</ORDER_NUMBER><PRODUCT>COD</PRODUCT>
                           <CONSIGNEE>TEST</CONSIGNEE><CONSIGNEE_ADDRESS1>ADDR1</CONSIGNEE_ADDRESS1><CONSIGNEE_ADDRESS2>
                           ADDR2</CONSIGNEE_ADDRESS2><CONSIGNEE_ADDRESS3>ADDR3</CONSIGNEE_ADDRESS3><DESTINATION_CITY>
                           MUMBAI</DESTINATION_CITY><PINCODE>400067</PINCODE><STATE>MH</STATE><MOBILE>156729</MOBILE>
                           <TELEPHONE>1234</TELEPHONE><ITEM_DESCRIPTION>MOBILE  </ITEM_DESCRIPTION><PIECES>1</PIECES>
                           <COLLECTABLE_VALUE> 3000 </COLLECTABLE_VALUE><DECLARED_VALUE> 3000 </DECLARED_VALUE>
                           <ACTUAL_WEIGHT>5</ACTUAL_WEIGHT><VOLUMETRIC_WEIGHT>0</VOLUMETRIC_WEIGHT><LENGTH> 10</LENGTH>
                           <BREADTH>10</BREADTH><HEIGHT>10</HEIGHT><VENDOR_ID>3012</VENDOR_ID></SHIPMENT>
                           <SHIPMENT><AWB_NUMBER>103085371</AWB_NUMBER><ORDER_NUMBER>1234</ORDER_NUMBER><PRODUCT>COD</PRODUCT>
                           <CONSIGNEE>TEST</CONSIGNEE><CONSIGNEE_ADDRESS1>ADDR1</CONSIGNEE_ADDRESS1><CONSIGNEE_ADDRESS2>ADDR2
                           </CONSIGNEE_ADDRESS2><CONSIGNEE_ADDRESS3>ADDR3</CONSIGNEE_ADDRESS3><DESTINATION_CITY>MUMBAI
                           </DESTINATION_CITY><PINCODE>400067</PINCODE><STATE>MH</STATE><MOBILE>156729</MOBILE><TELEPHONE>1234
                           </TELEPHONE><ITEM_DESCRIPTION>MOBILE  </ITEM_DESCRIPTION><PIECES>1</PIECES><COLLECTABLE_VALUE> 3000
                           </COLLECTABLE_VALUE><DECLARED_VALUE> 3000 </DECLARED_VALUE><ACTUAL_WEIGHT>5</ACTUAL_WEIGHT>
                           <VOLUMETRIC_WEIGHT>0</VOLUMETRIC_WEIGHT><LENGTH> 10</LENGTH><BREADTH>10</BREADTH><HEIGHT>10</HEIGHT>
                           <VENDOR_ID>3012</VENDOR_ID></SHIPMENT>
                           <SHIPMENT><AWB_NUMBER>103085372</AWB_NUMBER><ORDER_NUMBER>1234
                           </ORDER_NUMBER><PRODUCT>COD</PRODUCT><CONSIGNEE>TEST</CONSIGNEE><CONSIGNEE_ADDRESS1>ADDR1
                           </CONSIGNEE_ADDRESS1><CONSIGNEE_ADDRESS2>ADDR2</CONSIGNEE_ADDRESS2><CONSIGNEE_ADDRESS3>ADDR3
                           </CONSIGNEE_ADDRESS3><DESTINATION_CITY>MUMBAI</DESTINATION_CITY><PINCODE>400067</PINCODE>
                           <STATE>MH</STATE><MOBILE>156729</MOBILE><TELEPHONE>1234</TELEPHONE><ITEM_DESCRIPTION>MOBILE  
                           </ITEM_DESCRIPTION><PIECES>1</PIECES><COLLECTABLE_VALUE> 3000 </COLLECTABLE_VALUE><DECLARED_VALUE> 
                           3000 </DECLARED_VALUE><ACTUAL_WEIGHT>5</ACTUAL_WEIGHT><VOLUMETRIC_WEIGHT>0</VOLUMETRIC_WEIGHT>
                           <LENGTH> 10</LENGTH><BREADTH>10</BREADTH><HEIGHT>10</HEIGHT><VENDOR_ID>3012</VENDOR_ID></SHIPMENT>
                           </ECOMEXPRESS-OBJECTS>'''
            ...
            if data_check <> 1:
               return HttpResponse(data_check)

            airwaybill_check = awb_check(file_contents['ECOMEXPRESS-OBJECTS']['SHIPMENT'], capi)
            if airwaybill_check <> 1:
               return HttpResponse(airwaybill_check)
             
            subcustomer_check = subcust_check(file_contents['ECOMEXPRESS-OBJECTS']['SHIPMENT']) 
            if isinstance(subcustomer_check, dict):
                return HttpResponse(subcustomer_check)
  
            for ship_data in file_contents['ECOMEXPRESS-OBJECTS']['SHIPMENT']:
                reverse_pickup=0  
